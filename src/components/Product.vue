    ...
    <div class="product">
        <div :class="'product-inner ' + product.color">
            ...
            <div class="product-detail">
                <h2>{{ product.title }}</h2>
                <p>Best toilet paper in the world, get them now because your bum deserves better, Swipe and wipe!
                </p>
            </div>
            <br>
            <br>
...
<style >
    ...
    .product-inner.green {
        background-image: linear-gradient(to bottom right, #24D484, #24D484);
    }
        .product-inner.blue {
